(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[653,709],{JOjB:function(e,t,a){"use strict"
var r=a("ouhR")
var n=a.n(r)
var o=a("HGxv")
var i=a("8WeW")
...
a("jQeR")
a("0sPK")
var s=o["default"].scoped("lib.text_helper")
var l=a("gI0r")
var _,u,d
_="LINK-PLACEHOLDER"
u=/\b((?:https?:\/\/|www\d{0,3}[.]|[a-z0-9.\-]+[.][a-z]{2,4}\/)(?:[^\s()<>]+|\([^\s()<>]*\))+(?:\([^\s()<>]*\)|[^\s`!()\[\]{};:'".,<>?«»“”‘’]))|(LINK-PLACEHOLDER)/gi
t["a"]=d={quoteClump:function(e){return"<div class='quoted_text_holder'> <a href='#' class='show_quoted_text_link'>"+Object(l["a"])(s.t("quoted_text_toggle","show quoted text"))+"</a> <div class='quoted_text' style='display: none;'> "+n.a.raw(e.join("\n"))+" </div> </div>"},formatMessage:function(e){var t,a,r,n,o,i,s,p
n=[]
o=[]
...
if(r.match(/^(&gt;|>)/))s.push(r)
else{s.length&&i.push(d.quoteClump(s))
s=[]
i.push(r)}}s.length&&i.push(d.quoteClump(s))
...
a=Math.floor(a/1e3)
n=r+n}return o+String(a)+n},truncateText:function(e,t){var a,r,n,o,i,l
null==t&&(t={})
r=null!=(o=t.max)?o:30
a=s.t("ellipsis","...")
...
i=0
while(true){n=e.indexOf(l,i+1)
if(n<0||n>r-a.length)break
i=n}i||(i=r-a.length)
return e.substring(0,i)+a},plainText:function(e){return e.replace(/(<([^>]+)>)/gi,"")}}},msTH:function(e,t,a){"use strict"
var r=a("ouhR")
var n=a.n(r)
var o=a("Y/W1")
var i=a.n(o)
...
if(!(null!==(t=ENV)&&void 0!==t&&null!==(a=t.FEATURES)&&void 0!==a&&a.new_math_equation_handling)){const t=n()("<div/>").html(e.attr("x-canvaslms-safe-mathml")).html()
const a=n()('<span class="hidden-readable"></span>')
a.html(t)
return a}},toMediaCommentLink(e){const t=n()(`<a\n        id='media_comment_${Object(s["a"])(n()(e).data("media_comment_id"))}'\n        data-media_comment_type='${Object(s["a"])(n()(e).data("media_comment_type"))}'\n        class='instructure_inline_media_comment ${Object(s["a"])(e.nodeName.toLowerCase())}_comment'\n        data-alt='${Object(s["a"])(n()(e).attr("data-alt"))}'\n      />`)
t.html(n()(e).html())
return t},convert(e,t={}){const a=n()("<div />").html(e)
...
//# sourceMappingURL=653-c-5f76c23c3d.js.map